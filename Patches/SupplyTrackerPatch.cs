...
namespace LifeSupportTracker.Patches
{
    ...
    internal static class PauseScreenEscPatch
    {
        ...
        internal static void Apply(Harmony harmony, ManualLogSource log)
        {
            ...
            if (_pauseScreenType == null) { log.LogWarning("[LST] PauseScreen type not found — ESC eating disabled"); return; }
            ...
            if (count == 0) log.LogWarning("[LST] PauseScreen: no methods patched — ESC eating disabled");
